...
class NewShippingProductsScreen extends StatefulWidget {
  static const String routeName = '/newShippingProductsScreen';
  const NewShippingProductsScreen({Key? key}) : super(key: key);

  @override
  State<NewShippingProductsScreen> createState() =>
      _NewShippingProductsScreenState();
}

class _NewShippingProductsScreenState extends State<NewShippingProductsScreen> {
